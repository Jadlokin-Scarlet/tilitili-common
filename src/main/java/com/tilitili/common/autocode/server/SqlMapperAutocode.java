...
public class SqlMapperAutocode {
    ...
    public static void run() throws SQLException, IOException {
        ...
        String parameterType = AutocodeHelper.basePackageName + ".domain." + Table2Domain.domainName;
        ...
        //1.namespace
        head.append("<mapper namespace=\"").append(AutocodeHelper.basePackageName).append(".dao.mapper.").append(Table2Domain.domainName).append("Mapper\">").append("\n");
        //2.resultMap
        resultMap.append("<resultMap id=\"").append(Table2Domain.domainName).append("\" type=\"").append(parameterType).append("\">").append("\n");
        //3.insert
        insertHead.append("<insert id=\"add").append(Table2Domain.domainName).append("\" parameterType=\""+parameterType+"\">").append("\n");
        ...
        //6.getByCondition
        getByCondition.append("<select id=\"get").append(Table2Domain.domainName).append("ByCondition").append("\"  parameterType=\""+parameterType+"\"")
        ...
        for(Map.Entry<String, FieldPair> entry: Table2Domain.fieldPairMap.entrySet()) {
            ...
            //主键不更新,也不需要插入自动生成
            if(!columnName.equals(Table2Domain.PrimaryColumn)){
        ...
        insertTail.append("</trim>").append("\n")
                .append("<selectKey resultType=\"java.lang.Long\" keyProperty=\"").append(Table2Domain.PrimaryColumn).append("\">")
